    ...
    <ul id="sidebar-menu">
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <i class="fas fa-pencil-alt icon"></i> <!-- Cập nhật icon -->
        ...
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <i class="fas fa-cogs icon"></i> <!-- Cập nhật icon -->
        ...
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <i class="fas fa-th-large icon"></i> <!-- Cập nhật icon -->
        ...
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <i class="fas fa-industry icon"></i> <!-- Cập nhật icon -->
        ...
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <i class="fas fa-cart-arrow-down icon"></i> <!-- Cập nhật icon -->
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?modules=statistics&controllers=index&action=list" title="" class="nav-link aha">Thống kê</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
