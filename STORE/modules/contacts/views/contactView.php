        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn_submit_crate'])) {
            ...
            if (!empty($fullname) && !empty($user_email) && !empty($note)) {
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'taitaongu65@gmail.com'; // Thay bằng email của bạn
                    $mail->Password = 'xfdl vqhz mjqb wluo';    // Thay bằng mật khẩu ứng dụng
                    $mail->SMTPSecure = 'ssl';
                    $mail->Port = 465;
                    // Cấu hình người gửi và người nhận
                    $mail->setFrom($user_email, $fullname);
                    $mail->addAddress('tunt.23it@vku.udn.vn', 'nguyen thanh tu');
